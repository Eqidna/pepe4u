        ...
        <div className={styles.container}>
          <main className={styles.main}>
            ...
            <div className={styles.grid}>
              ...
              >
                <h2 className={styles.heading} style={{ color: 'white' }}>BUY $QDNA &rarr;</h2>
              ...
              <a
                ...
                className={styles.card}
              >
                <h2 className={styles.heading} style={{ color: 'white' }}>Polygonscan $QDNA &rarr;</h2>
                <p className={styles.paragraph} style={{ color: 'red' }}>
              ...
              <a
                ...
                className={styles.card}
              >
                <h2 className={styles.heading} style={{ color: 'white' }}>Follow @EqidnaTokenQDNA &rarr;</h2>
                <p className={styles.paragraph} style={{ color: 'red' }}>
            ...
            <div className={styles.grid}>
              <a
                ...
                className={styles.card}
              >
                <h2 className={styles.heading} style={{ color: 'white' }}>LEARN MORE: $QDNA &rarr;</h2>
                <p className={styles.paragraph} style={{ color: 'red' }}>
                  Want to know more about Eqidna?
                  Click here!
                </p>
              </a>
              ...
              <a
                ...
                className={styles.card}
              >
                <h2 className={styles.heading} style={{ color: 'white' }}>Coingecko $QDNA &rarr;</h2>
                <p className={styles.paragraph} style={{ color: 'red' }}>
              ...
              <a
                href="https://github.com/Eqidna/QDNA"
                className={styles.card}
              >
                <h2 className={styles.heading} style={{ color: 'white' }}>github @QDNA &rarr;</h2>
                <p className={styles.paragraph} style={{ color: 'red' }}>
